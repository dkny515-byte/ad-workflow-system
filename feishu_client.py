...
class FeishuClient:
    ...
    async def send_webhook(self, text: str, at_users: list = None, title: str = None) -> bool:
        """发送群机器人消息，支持@用户（使用post消息类型）"""
        ...
        try:
            ...
            # 添加文本内容
            if text:
                content_items.append({"tag": "text", "text": text})
